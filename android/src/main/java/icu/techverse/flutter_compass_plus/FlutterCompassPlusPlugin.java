package icu.techverse.flutter_compass_plus;
...
public final class FlutterCompassPlusPlugin implements FlutterPlugin, StreamHandler {
    ...
    public FlutterCompassPlusPlugin() {
        // no-op
    }
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        channel = new EventChannel(binding.getBinaryMessenger(), "flutter_compass_plus");
